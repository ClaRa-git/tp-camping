 ...
 */
final class Version20250207110323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE price (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, price INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, bedding INT NOT NULL, surface INT NOT NULL, location INT NOT NULL, INDEX IDX_1619C27DC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, rental_id INT DEFAULT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, adults_number INT NOT NULL, kids_number INT NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C84955A7CF2329 (rental_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(100) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type_price (type_id INT NOT NULL, price_id INT NOT NULL, INDEX IDX_C4C4A52EC54C8C93 (type_id), INDEX IDX_C4C4A52ED614C7E7 (price_id), PRIMARY KEY(type_id, price_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE type_price ADD CONSTRAINT FK_C4C4A52EC54C8C93 FOREIGN KEY (type_id) REFERENCES type (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE type_price ADD CONSTRAINT FK_C4C4A52ED614C7E7 FOREIGN KEY (price_id) REFERENCES price (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_price DROP FOREIGN KEY FK_C4C4A52EC54C8C93');
        $this->addSql('ALTER TABLE type_price DROP FOREIGN KEY FK_C4C4A52ED614C7E7');
